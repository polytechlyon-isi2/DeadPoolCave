...
insert into t_article values
(3, 'Ms. Marvel (2014) #19','Elle combattait les petits délinquants, arrêtait les super-vilains et avait même vaincu son démoniaque ex-mari. Mais maintenant que Kamala Khan a enfin trouvé sa voie de héros, la planète Gotta s’apprête à entrer en collision avec une Terre alternative ... normale. Quand le monde se termine, où Kamala passera ses derniers jours ..?','Marvel','Super-Hero','Ms. Marvel',10,'http://x.annihil.us/u/prod/marvel/i/mg/8/c0/561bd4221fa7b/detail.jpg');

insert into t_article values
(4, 'GUARDIANS OF INFINITY (2015) #5','Les ambitions maléfiques de Hermeticus sont énormes, on pourrait même dire qu\'ils sont  à l\'échelle GALACTIQUE! Est-ce que ce méchant possède une étrange connexion avec les Guardians? Même si Rocket, Drax et Groot ont rejoint un super-groupe de gardiens, ils pourraient être sur leurs traces!','Marvel','Science-Fiction','GUARDIANS OF INFINITY',10,'http://x.annihil.us/u/prod/marvel/i/mg/8/70/570c11c0d3bb7/detail.jpg');
